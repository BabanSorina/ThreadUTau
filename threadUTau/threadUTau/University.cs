...
namespace threadUTau
{
    public partial class University : Form
    {
        ...
        public University(String username)
        {
            InitializeComponent();
            DataTable table = service.insertTable_un();
        ...
        private void buttonPost_Click(object sender, EventArgs e)
        {
            ...
            service.postMessage("University", post, label1.Text);
            DataTable table = service.insertTable_un();
            dataGridView1.DataSource = table;
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            service.deleteMessage("University", Convert.ToInt32(dataGridView1.SelectedCells[0].Value.ToString()), Convert.ToString(dataGridView1.SelectedCells[2].Value.ToString()), username_labell);
            DataTable table = service.insertTable_un();
            dataGridView1.DataSource = table;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            String currentThread = "University";
            this.Hide();
