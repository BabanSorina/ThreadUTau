...
namespace threadUTau
{
    public partial class Transport : Form
    {
        ...
        public Transport(String username)
        {
            InitializeComponent();
            DataTable table = service.insertTable_tr();
        ...
        private void buttonPost_Click(object sender, EventArgs e)
        {
            ...
            service.postMessage("Transport", post, label1.Text);
            DataTable table = service.insertTable_tr();
            dataGridView1.DataSource = table;
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            service.deleteMessage("Transport", Convert.ToInt32(dataGridView1.SelectedCells[0].Value.ToString()), Convert.ToString(dataGridView1.SelectedCells[2].Value.ToString()), username_labell);
            DataTable table = service.insertTable_tr();
            dataGridView1.DataSource = table;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            String currentThread = "Transport";
            this.Hide();
